...
class RoomViewModel(
    ...
    val soundDetectionListener =
        object : OnSoundDetectedListener {
    ...
    fun focusVideo(participantId: String) {
        ...
        candidates.find {
            ...
            if (localVideoTrack?.id() != primaryParticipantTrackId &&
                ...
                val globalId =
                    globalToLocalTrackId.filterValues { it1 ->
    ...
    fun toggleMicrophone() {
        ...
        if (p != null) {
            mutableParticipants[localEndpointId] =
                p.updateTrackMetadata(
                    p.audioTrack?.id(),
        ...
        room.value?.let {
            ...
            videoParameters =
                videoParameters.copy(
                    ...
                    maxBitrate =
                        TrackBandwidthLimit.SimulcastBandwidthLimit(
                            mapOf(
            ...
            mutableParticipants[localEndpointId] =
                participant.updateTrackMetadata(
    ...
    override fun onTrackRemoved(ctx: TrackContext) {
        if (ctx.metadata["type"] == "screensharing") {
            ...
            val participant =
                mutableParticipants[ctx.endpoint.id]
    ...
    fun startScreencast(mediaProjectionPermission: Intent) {
        ...
        localScreencastTrack =
            room.value?.createScreencastTrack(
        ...
        localScreencastTrack?.let {
            mutableParticipants[localScreencastId!!] =
                Participant(
